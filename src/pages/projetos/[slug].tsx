    ...
    <>
      ...
      <main className="min-h-screen bg-gray-950 text-white px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <Link
            href="/projetos"
            className="text-teal-400 hover:text-teal-300 underline mb-6 inline-block"
          >
            {"<-"} {t("projects.back", "Voltar para projetos")}
          </Link>
          <article className="bg-gray-900 p-8 rounded-xl shadow-xl border border-gray-700">
            <header>
            ...
            <section className="mb-4">
              <p className="text-lg mb-4 text-gray-300">{descricao}</p>
            </section>
