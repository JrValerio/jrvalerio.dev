...
export default function Sobre() {
  ...
  // SEO description adaptada à linguagem
  const metaDesc = {
    pt: "Amaro Júnior — Desenvolvedor Full Stack em Atibaia/SP. Especialista em React, Node.js, acessibilidade e soluções de impacto social. Portfólio com história real de resiliência, propósito e inovação.",
    en: "Amaro Júnior — Full Stack Developer based in Atibaia, Brazil. Specialist in React, Node.js, accessibility and social impact projects. Portfolio with a real story of resilience, purpose, and innovation.",
    es: "Amaro Júnior — Desarrollador Full Stack en Atibaia, Brasil. Especialista en React, Node.js, accesibilidad y proyectos de impacto social. Portafolio con una historia real de resiliencia, propósito e innovación."
  };
  ...
  return (
    <>
      <Head>
        <title>
          {t("about.title")} - {t("name") || "Amaro Júnior"}
        </title>
        <meta
          name="description"
          content={metaDesc[i18n.language as "pt" | "en" | "es"] || metaDesc.pt}
        />
        <meta property="og:title" content={`${t("about.title")} - ${t("name") || "Amaro Júnior"}`} />
        <meta property="og:description" content={metaDesc[i18n.language as "pt" | "en" | "es"] || metaDesc.pt} />
        <meta property="og:url" content="https://jrvalerio.dev/sobre" />
        <meta property="og:image" content="/img/perfil2.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${t("about.title")} - ${t("name") || "Amaro Júnior"}`} />
        ...
        <link rel="canonical" href="https://jrvalerio.dev/sobre" />
      </Head>
      <section className="min-h-[80vh] bg-gray-900 flex flex-col items-center justify-center py-8">
        <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-white/5 backdrop-blur-md border border-gray-800 shadow-lg mb-10">
          ...
          <div className="text-white/90 leading-relaxed text-lg mb-6 text-justify space-y-4">
            {t("about.body")
              .split(/\n\s*\n/)
              .map((paragrafo, idx) => (
          ...
          <div className="flex items-center gap-4 mt-6 flex-wrap">
            ...
            <Link
              href="/techs"
              className="inline-flex items-center text-lg text-teal-400 hover:text-blue-400 transition underline"
            >
