...
const techs = [
  ...
  { name: "Next.js", icon: <SiNextdotjs className="text-gray-800 dark:text-gray-100" />, descKey: "nextjs" },
  { name: "Node.js", icon: <FaNodeJs className="text-green-600" />, descKey: "nodejs" },
  { name: "Express", icon: <SiExpress className="text-gray-700 dark:text-gray-200" />, descKey: "express" },
  ...
  { name: "Django", icon: <SiDjango className="text-green-800 dark:text-green-400" />, descKey: "django" },
  ...
  { name: "GitHub", icon: <FaGithub className="text-gray-700 dark:text-gray-300" />, descKey: "github" },
...
export default function Techs() {
  ...
  return (
    <>
      ...
      <section className="min-h-[80vh] flex flex-col items-center justify-center py-12 bg-gray-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 transition-colors">
        <div className="max-w-4xl w-full px-6 py-10 rounded-2xl bg-white/80 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-800 shadow-lg mb-10">
          ...
          <p className="text-center text-gray-700 dark:text-white/70 max-w-2xl mx-auto mb-6">
            {t("techs.intro")}
          </p>
            ...
            {techs.map((tech) => {
              ...
              return (
                <div
                  ...
                  className="relative group flex flex-col items-center gap-2 bg-white dark:bg-black/40 border border-gray-200 dark:border-gray-700 rounded-xl p-4 shadow transition hover:scale-105 hover:bg-teal-50 dark:hover:bg-teal-950/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400"
                >
                  <span className="text-4xl">{tech.icon}</span>
                  <span className="text-xs sm:text-sm text-gray-700 dark:text-white/80 text-center">
                    {tech.name}
                  </span>
                  <span
                    id={tooltipId}
                    ...
                    px-3 py-2 min-w-[160px] rounded bg-gray-100 dark:bg-gray-900 text-xs text-gray-800 dark:text-gray-100 border border-gray-300 dark:border-gray-700
